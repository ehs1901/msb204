...
Da vi har hatt litt problemer med det fullstendige datasettet vårt (merged_data), har vi utarbeidet et nytt datasett kalt transport_splitt hvor vi har delt opp transportmidlene som var adskilt med semikolon i ‘Hvordan_kommer_du_deg_til_jobb’-kolonnen for å forenkle videre analyse.
Dette tillot oss å trimme og fjerne tomme verdier fra dataene, slik at kun gyldige svar ble inkludert.
Videre fjernet vi rader med manglende data og lagde en oppsummering som viser antall ganger hvert transportmiddel ble valgt, hvilket gir oss en klarere oversikt over preferansene i datasettet.
