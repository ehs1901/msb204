...
![](images/Skjermbilde 2024-11-06 kl. 12.00.17.png){width="165"}
...
![](images/Skjermbilde 2024-11-06 kl. 12.03.30.png){width="92"}
...
![](images/Skjermbilde%202024-11-04%20kl.%2015.17.00.png)

![](images/Skjermbilde%202024-11-04%20kl.%2015.21.05.png)

![](images/Skjermbilde%202024-11-04%20kl.%2015.17.32.png)
...
Ved å analysere disse sannsynlighetene, kan vi identifisere hvilke faktorer som sterkest påvirker valg av transportmiddel.

**Tid brukt til jobb:**

Basert på resultatene er det tydelig at reisetid har en signifikant innvirkning på valg av transportmiddel for arbeidsreiser.

Korte reisetider (0–9 minutter) reduserer sannsynligheten for å velge bil, mens det øker sannsynligheten for å velge buss, sykkel, EL-sykkel og EL-sparkesykkel .
Dette antyder at kortere reiser fremmer valg av mer aktive transportmidler.

For lengre reisetider, spesielt i intervallet 20–39 minutter, ser vi at sannsynligheten for å bruke buss og bil øker, noe som tyder på at disse transportmidlene foretrekkes når avstanden til jobb er større.
Samtidig ser vi at el-sparkesykkel og sykkel brukes betydelig mindre ved reisetider over 20 minutter.

Ved svært lange reisetider (over 60 minutter) blir bil og buss de mest foretrukne transportmidlene, mens sannsynligheten for å velge aktive transportmidler som gange og sykkel er svært lav.
Disse funnene indikerer at reisetid har en klar sammenheng med transportmiddelvalg og understreker viktigheten av å tilby kollektivtransport og tilrettelegging for sykling og gange i områder med kortere reiseavstand til arbeidsplasser.
...
Fra våres resultater er det relativt få variabler med høye p-verdier, noe som indikere at de fleste variablene i modellen har en statistisk signifikant effekt på avhenigige variabler.

**Parkering ved jobb ("Nei")** har en p-verdi på rundt 0.601, som er relativt høy sammenlignet med andre variabler i modellen.
Dette betyr at effekten av ikke å ha parkering ved jobb ikke er statistisk signifikant når det gjelder valg av transportmiddel, noe som kan tyde på at tilgang til parkering kanskje ikke er en sterk prediktor for transportmiddelvalg i denne modellen.

**Inntektsgruppe (0 - 999 000)** har en p-verdi på 0.649, som også indikerer mangel på statistisk signifikans.
Dette kan tyde på at inntekt i denne høyeste kategorien ikke nødvendigvis påvirker valg av transportmiddel på en signifikant måte sammenlignet med referansekategorien.
